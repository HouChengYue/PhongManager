...
public class SpeedupActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String title = getResources().getString(R.string.rocket);
    ...
    private void initMainButton() {
        ...
        initPhoneData();//获取手机信息
        initRamData();//设置内存信息
    }

    private void initPhoneData() {
        tv_phoneName.setText(SystemManager.getPhoneName().toUpperCase());//获取手机名字转换大写
        tv_phoneModle.setText(SystemManager.getPhoneModelName());//型号
    }
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        runingAppAdapter.setState(RuningAppAdapter.STATE_SHOW_SYS);
                    ...
                    if (runingAppinfos != null) {
                        ...
                        switch (runingAppAdapter.getState()) {
                            ...
                            case RuningAppAdapter.STATE_SHOW_USER:
                                ...
                                btn_showall.setText(getResources().getString(R.string.speedup_show_allapp));
                                break;
                            // 在显示所用应用状态下
                            case RuningAppAdapter.STATE_SHOW_ALL:
                                Log.d("显示状态", "全部！");
                                runingAppAdapter.setDataToAdapter(runingAppinfos.get(AppInfoManager.RUNING_APP_TYPE_All));
                                runingAppAdapter.setState(RuningAppAdapter.STATE_SHOW_SYS);
                                btn_showall.setText(getResources().getString(R.string.speedup_show_sysapp));
                                break;
                            case RuningAppAdapter.STATE_SHOW_SYS:
                                Log.d("显示状态", "系统！");
                                runingAppAdapter.setDataToAdapter(runingAppinfos.get(AppInfoManager.RUNING_APP_TYPE_SYS));
